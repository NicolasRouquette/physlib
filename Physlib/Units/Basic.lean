...
noncomputable def dimScale (u1 u2 : UnitChoices) :Dimension PhyslibBase →* ℝ≥0 where
  toFun d :=
...
lemma dimScale_apply (u1 u2 : UnitChoices) (d : Dimension PhyslibBase) :
    dimScale u1 u2 d =
      (u1.length / u2.length) ^ (d.length : ℝ) *
      (u1.time / u2.time) ^ (d.time : ℝ) *
      (u1.mass / u2.mass) ^ (d.mass : ℝ) *
...
@[simp]
lemma dimScale_self (u : UnitChoices) (d : Dimension PhyslibBase) :
    dimScale u u d = 1 := by
  simp [dimScale]
...
lemma dimScale_transitive (u1 u2 u3 : UnitChoices) (d : Dimension PhyslibBase) :
...
@[simp]
lemma dimScale_mul_symm (u1 u2 : UnitChoices) (d : Dimension PhyslibBase) :
    dimScale u1 u2 d * dimScale u2 u1 d = 1 := by
  rw [dimScale_transitive, dimScale_self]

@[simp]
lemma dimScale_coe_mul_symm (u1 u2 : UnitChoices) (d : Dimension PhyslibBase) :
...
@[simp]
lemma dimScale_ne_zero (u1 u2 : UnitChoices) (d : Dimension PhyslibBase) :
    dimScale u1 u2 d ≠ 0 := by
  simp [dimScale]

lemma dimScale_symm (u1 u2 : UnitChoices) (d : Dimension PhyslibBase) :
...
lemma dimScale_of_inv_eq_swap (u1 u2 : UnitChoices) (d : Dimension PhyslibBase) :
    dimScale u1 u2 d⁻¹ = dimScale u2 u1 d := by
  simp only [map_inv]
...
lemma smul_dimScale_injective {M : Type} [MulAction ℝ≥0 M] (u1 u2 : UnitChoices)
    (d : Dimension PhyslibBase) (m1 m2 : M) :
...
@[simp]
lemma dimScale_pos (u1 u2 : UnitChoices) (d : Dimension PhyslibBase) :
...
@[simp]
lemma dimScale_SI_SIPrimed (d : Dimension PhyslibBase) :
...
@[simp]
lemma dimScale_SIPrimed_SI (d : Dimension PhyslibBase) :
